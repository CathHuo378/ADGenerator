...
def generate_users(session, domain_name, domain_sid, num_nodes, current_time, first_names, last_names, users, disable_users, ridcount, parameters):
    ...
    return user_properties_list, users, disable_users, ridcount
