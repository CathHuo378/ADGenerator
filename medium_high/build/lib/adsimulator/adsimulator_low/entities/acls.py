from adsimulator.adsimulator_low.templates.groups import STANDARD_GROUPS
from adsimulator.adsimulator_low.entities.users import get_standard_users_list
