import random
import math
from adsimulator_low.utils.principals import get_sid_from_rid, get_name, get_dn
from adsimulator_low.utils.computers import get_computer_dn, get_computer_name,\
    generate_client_service_pricipal_names, generate_server_service_pricipal_names,\
    is_os_vulnerable
from adsimulator_low.utils.boolean import generate_boolean_value
from adsimulator_low.utils.time import generate_timestamp
from adsimulator_low.utils.ous import get_ou_dn
from adsimulator_low.utils.parameters import get_perc_param_value, get_dict_param_value,\
    print_computer_generation_parameters, print_dc_generation_parameters
from adsimulator_low.templates.ous import STATES
from adsimulator_low.templates.computers import get_client_os_list, get_server_os_list, get_main_dc_os
from adsimulator_low.templates.default_values import get_complementary_value
